...
import { MetaDataList } from 'src/app/pages/home/meta-data.model';
...
export class AdvanceFiltersComponent {
  research!: any[];
  user: any;
  filteredResearches: any;
  searchQuery: any;
  ...
  updateSelectedCourt(event: any) {
    this.selectedCourt = event;
